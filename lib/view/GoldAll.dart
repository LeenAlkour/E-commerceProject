...
class _GoldAllState extends State<GoldAll> {
  @override
  final GoldController goldAllService = Get.find();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (goldAllService.goldAllList.isEmpty) {
          ...
          return GridView.builder(
            ...
            itemCount: goldAllService.goldAllList.length,
            itemBuilder: (BuildContext context, int index) {
              final imageUrl = goldAllService.goldAllList[index]['id'];
              return Padding(
