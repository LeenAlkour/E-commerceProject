...
class _EarringsJewelryGoldState extends State<EarringsJewelryGold> {
  @override
  void initState() {
    _goldController.getEarringsGold();
              ...
              child: CustomRadioButton(
                ...
                radioButtonValue: (value) {
                  switch (value) {
                    ...
                    case '3':
                      {
                        _goldController.getEarringsGoldByDes();
                    ...
                    case '4':
                      {
                        _goldController.getEarringsGoldByAsc();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      onTap: () {
                                        _goldController.getEarringsGoldBetween(_goldController.price1.value,_goldController.price2.value);
        ...
        if (_goldController.goldEarringsList.isEmpty) {
          ...
          return GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return GestureDetector(onTap: (){ Get.to(DetProductGold(),arguments: [_goldController.goldEarringsList[index]['id']]);},
                child: Padding(
                  ...
                  child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Align(alignment: Alignment.bottomLeft
                            ,child: Text("${_goldController.goldEarringsList[index]['final_price']} \$",style: TextStyle(fontSize: 20),)),
                      ),),
                ),
              );
//   Image.network(
